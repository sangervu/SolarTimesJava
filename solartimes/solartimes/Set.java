...
public class Set {
    ...
    public Set(double alfa, double delta, double T, double latitude, double longitude, double timeStellarNoon) {
        ...
        this.timeSetHorizonString = (TimeFormat.hourTimeString) + ":" + (TimeFormat.minuteTimeString);
